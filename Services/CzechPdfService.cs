...
{
    public partial class CzechPdfService : IPdfService
    {
        #region Fields

        private const string OrderTemplate = "~/Views/CzechPdfTemplates/OrderPdfTemplate.cshtml";
        private const string ShipmentsTemplate = "~/Views/CzechPdfTemplates/ShipmentPdfTemplate.cshtml";
        ...
        public CzechPdfService(IViewRenderService viewRenderService, IRepository<Download> downloadRepository,
